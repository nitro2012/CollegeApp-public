...
import com.example.collegeapp.FullPage;
import com.example.collegeapp.NumbersView;
import com.example.collegeapp.NumbersViewAdapter;
import com.example.collegeapp.R;
import com.example.collegeapp.ebook.pdfViewer;
...
public class feedAdapter extends RecyclerView.Adapter<feedAdapter.feedViewAdapter> {
    ...
    public feedViewAdapter onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new feedAdapter.feedViewAdapter(view);
    }
